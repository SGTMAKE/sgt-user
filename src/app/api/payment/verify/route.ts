        ...
        if (successOrder) {
          await emailService.sendOrderNotification({
            ...
            orderItems: successOrder.orderItems.map((item) => ({
              ...
              customProductData: item.customProduct,
            })),
            shippingAddress: {name: successOrder.address.name,
              phone: successOrder.address.phone || "",
              address: successOrder.address.address,
              locality: successOrder.address.locality || "",
              district: successOrder.address.district || "",
              state: successOrder.address.state,
              pincode: successOrder.address.pincode,
              },
            paymentStatus: true,
