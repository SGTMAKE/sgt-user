...
import { ArrowLeft, ShoppingCart, Cable, Loader2, Plus, Minus } from "lucide-react"
...
export default function WireCategoryPage() {
  ...
  const fetchCategoryData = async () => {
    ...
    try {
      ...
      const categoryResponse = await fetch(`/api/wires/categories/${categoryId}`)
      ...
      const optionsResponse = await fetch(`/api/wires/categories/${categoryId}/options`)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      addItem(quoteItem)
      toast.success("Wire added to quote cart!")
      ...
      toast.error("Failed to add wire to cart")
    } finally {
      setSubmitting(false)
    }
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="flex items-center gap-3">
          ...
          <span className="text-gray-600 dark:text-gray-400">Loading wire details...</span>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Wire Not Found</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">The requested wire category could not be found.</p>
              ...
              <CardHeader className="static md:sticky top-0 left-0">
                 {category.image ? (
                    ...
                    <div className="w-20 h-20 rounded-lg bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-900/20 dark:to-orange-800/20 flex items-center justify-center flex-shrink-0">
                      <Cable className="w-10 h-10 text-orange-500" />
                    </div>
                  )}
              </CardHeader>
            </Card>
